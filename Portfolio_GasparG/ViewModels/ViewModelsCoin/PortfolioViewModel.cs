...
namespace Portfolio_GasparG.ViewModels.ViewModelsCoin
{
    ...
    {    
       ...
       internal async Task ExecuteLoadPortfoliosCommand()
        ...
        {
            await Rg.Plugins.Popup.Services.PopupNavigation.Instance.PushAsync(new Portfolio_GasparG.ViewsCoin.Alertify(errorText));
         ...
         internal async void AddTransaction(Portfolio portfolio, CoinsHodle coinsHodle, string Quantity, string Fee, string PriceBought, DateTime datetime)
        {
            ...
            var Transaction = new Models.ModelsCoin.Transactions();
